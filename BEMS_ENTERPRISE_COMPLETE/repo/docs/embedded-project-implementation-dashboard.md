...
| --- | --- | --- |
| Zephyr RTOS IoT Sensor Node | Zephyr Wi-Fi/BLE sensor node | Thread tests, power profile, OTA rollback, MQTT smoke test |
...
| Bare-Metal RTOS Scheduling | FreeRTOS or Zephyr firmware | IPC tests, scheduler trace, contention report |
...
| Medical Wearable Power Manager | RTOS wearable MCU | Sleep residency, DMA capture, runtime estimate |
| Connected IoT Device | Secure MQTT RTOS node | Cloud publish, cert rotation, battery profile, OTA smoke |
